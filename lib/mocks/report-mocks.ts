...
export const MOCK_POSITIONING: Positioning = {
  primary: {
    ...
    fitReason:
      "量表显示你的执行落地能力突出，且压力适应稳定，恰好契合金融客服岗「高频操作 + 情绪稳定」的双重要求。加上你有一定的沟通基础，入门后能较快建立服务节奏。",
    specialNote:
      "金融客服需要熟悉基础金融术语和合规话术，建议在面试前用 1-2 周时间研读目标机构官网的产品页，挑 3-5 个高频产品（如信用卡、理财、贷款）练习用通俗语言解释给陌生人听，这是面试官最常考的实操场景。",
  },
  secondary: {
    position: "行政人事助理",
    matchScore: 75,
    ...
    fitReason:
      "做事有条理、不容易遗漏细节，恰好满足行政人事岗「多线任务、每件不出错」的核心要求。协作意识分值较高，可以顺畅对接多部门，这是行政人事岗的日常节奏。",
    specialNote:
      "行政人事操作涉及劳动合同、社保公积金的法规细节，差错成本较高。建议通过 12333 免费课程或网络公开课提前补充《劳动合同法》基础知识，面试时能说出 1-2 个合规操作要点，会大幅提升可信度。",
  },
};
  ...
  issues: [
    {
      ...
      revisionExample:
        "改前：「负责日常客户服务工作，处理客户咨询」\n改后：「日均处理客户来电与现场咨询 20+ 件，常见问题一次性解决率约 75%，连续 2 个月客户满意度评分 4.7/5」",
    },
    {
      title: "缺少量化成果",
      detail:
      ...
      priority: "medium",
      revisionExample:
        "改前：「参与策划社团活动，效果良好」\n改后：「参与策划迎新晚会，统筹 6 人执行组，当天到场人数 200+ 人，活动后收集满意度问卷回收率 80%，平均评分 4.6 分」",
    },
    {
      title: "技能栈没有主次",
      detail:
      ...
      priority: "low",
      revisionExample:
        "改前：「Word / Excel / PPT / PS / PR / 剪映 / 抖音运营 / 活动策划 / 文案编辑」\n改后：「熟练：Excel 数据整理、PPT 演示制作 | 使用过：PS 图片处理、剪映视频剪辑 | 了解：短视频运营基础」",
    },
  ],
  suggestions: [
    {
