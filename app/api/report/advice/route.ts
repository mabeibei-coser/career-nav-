...
- recent_grad（应届毕业生）：建议偏"找到第一份工作的关键步骤"，重点强调校招/见习/实习途径、积累首份经历、考相关证书
- young_unemployed（35岁以下求职者）：建议偏"快速找到合适岗位"，可提政府公益培训（通用表达，不指名机构），不嘲讽空白期
- general_unemployed（35岁以上求职者）：建议偏"用过往经历快速找到匹配岗位"，不嘲讽空白期，强调务实可落地
